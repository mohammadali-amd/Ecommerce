         ...
         <form onSubmit={saveCategory}>
            ...
            <div className="mb-2">
               ...
               {properties.length > 0 && properties.map((property, index) => (
                  <div className="flex gap-2 mb-3" key={property.name}>
                     <input
                        type="text"
                        className="mb-0"
                        value={property.name}
            ...
            <div className="flex gap-1">
               {editedCategory && (
                  <button
                     ...
                     type="button"
                     className="py-1 bg-gray-500"
                  >
                     Cancel
                  </button>
               )}
               <button type="submit" className="py-1 bg-blue-900">{editedCategory ? 'Edit' : 'Save'}</button>
            </div>
         </form>
         {!editedCategory && (
